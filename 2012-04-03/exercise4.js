/**
 * Istanzio tre tavoli davanti alle panchine.
 * Sarebbe più sensato collocarli in una delle
 * zone coperte, ma ho preferito una posizione
 * più visibile per facilitare la correzione.
 *
 */
var t1 = tavolo();
var t2 = tavolo();
...
function tavolo() {
	var base = SIMPLEX_GRID([[2],[1],[0.1]]);
	base = T([2])([0.9])(base);
	var piedi = SIMPLEX_GRID([[0.1,-1.8,0.1],[0.1,-0.8,0.1],[0.9]]);

	return STRUCT([base, piedi]);
}
